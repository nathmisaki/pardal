...
Quando /^(?:eu )?clic(?:o|ar em) "([^\"]*)"$/ do |link|
  When %{I follow "#{link}"}
end

Quando /^(?:eu )?clic(?:o|ar em) "([^\"]*)" dentro de "([^\"]*)"$/ do |link, parent|
...
Então /^(?:eu )?dev(?:o|eria) ver "([^\"]*)"$/ do |text|
  Then %{I should see "#{text}"}
end

Então /^(?:eu )?dev(?:o|eria) ver "([^\"]*)" dentro de "([^\"]*)"$/ do |text, selector|
  Then %{I should see "#{text}" within "#{selector}"}
end

Então /^(?:eu )?dev(?:o|eria) ver \/([^\/]*)\/$/ do |regexp|
  Then %{I should see /#{regexp}/}
end

Então /^(?:eu )?dev(?:o|eria) ver \/([^\/]*)\/ dentro de "([^\"]*)"$/ do |regexp, selector|
